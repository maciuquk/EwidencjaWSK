    ...
    public partial class i1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountDocs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccountDocs_Records_RecordId",
                        column: x => x.RecordId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Suppliers_Records_SupplierId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseDocs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WarehouseDocs_Records_RecordId",
                        column: x => x.RecordId,
                        principalTable: "Records",
                        principalColumn: "RecordId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseDocs_RecordId",
                table: "WarehouseDocs",
                column: "RecordId");
        }
